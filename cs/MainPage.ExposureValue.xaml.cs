...
namespace CameraManualControls
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            var exposureCompensationControl = _previewer.MediaCapture.VideoDeviceController.ExposureCompensationControl;
        ...
        private async void EvSlider_ValueChanged(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            ...
            float stepSize = _previewer.MediaCapture.VideoDeviceController.ExposureCompensationControl.Step;

            var value = (sender as Slider).Value;
            await _previewer.MediaCapture.VideoDeviceController.ExposureCompensationControl.SetValueAsync((float)value * stepSize);
