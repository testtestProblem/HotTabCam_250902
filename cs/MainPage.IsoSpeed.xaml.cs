...
namespace CameraManualControls
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            var isoSpeedControl = _previewer.MediaCapture.VideoDeviceController.IsoSpeedControl;
        ...
        private async void IsoSlider_ValueChanged(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            ...
            await _previewer.MediaCapture.VideoDeviceController.IsoSpeedControl.SetValueAsync((uint)value);
        }
        ...
        private async void IsoAutoCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (autoIso)
            {
                await _previewer.MediaCapture.VideoDeviceController.IsoSpeedControl.SetAutoAsync();
            }
            else
            {
                await _previewer.MediaCapture.VideoDeviceController.IsoSpeedControl.SetValueAsync((uint)IsoSlider.Value);
            }
        }
