    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void UpdateFlashControlCapabilities()
        {
            ...
            if (flashControl.Supported)
            {
                ...
                if (_previewer.MediaCapture.VideoDeviceController.TorchControl.Supported)
                {
        ...
        {
            // Note that the FlashControl only applies to photos. To turn on the light for video recording, use the _previewer.MediaCapture.VideoDeviceController.TorchControl

            _previewer.MediaCapture.VideoDeviceController.FlashControl.Enabled = true;
            _previewer.MediaCapture.VideoDeviceController.FlashControl.Auto = false;
        }

        private void FlashAutoRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            _previewer.MediaCapture.VideoDeviceController.FlashControl.Enabled = true;
            _previewer.MediaCapture.VideoDeviceController.FlashControl.Auto = true;
        }

        private void FlashOffRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            _previewer.MediaCapture.VideoDeviceController.FlashControl.Enabled = false;
        }

        private void RedEyeFlashCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            _previewer.MediaCapture.VideoDeviceController.FlashControl.RedEyeReduction = (RedEyeFlashCheckBox.IsChecked == true);
        }

        private void TorchCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            _previewer.MediaCapture.VideoDeviceController.TorchControl.Enabled = (TorchCheckBox.IsChecked == true);
        }
