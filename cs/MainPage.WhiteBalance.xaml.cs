...
namespace CameraManualControls
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            var whiteBalanceControl = _previewer.MediaCapture.VideoDeviceController.WhiteBalanceControl;
        ...
        private async void WbComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            await _previewer.MediaCapture.VideoDeviceController.WhiteBalanceControl.SetPresetAsync(selected);
        ...
        private async void WbSlider_ValueChanged(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            ...
            await _previewer.MediaCapture.VideoDeviceController.WhiteBalanceControl.SetValueAsync((uint)value);
        }
