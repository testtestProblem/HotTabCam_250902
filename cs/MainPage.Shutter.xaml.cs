...
namespace CameraManualControls
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            var exposureControl = _previewer.MediaCapture.VideoDeviceController.ExposureControl;
        ...
        private async void ShutterSlider_ValueChanged(object sender, Windows.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
        {
            ...
            await _previewer.MediaCapture.VideoDeviceController.ExposureControl.SetValueAsync(value);
        }
        ...
        private async void ShutterCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            ...
            await _previewer.MediaCapture.VideoDeviceController.ExposureControl.SetAutoAsync(autoShutter);
        }
